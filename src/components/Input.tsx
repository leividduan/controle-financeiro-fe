...
function Input({type, id, name, placeholder, required, error, onChange} : InputType) {
  ...
  return (
    <>
      <input type={type} name={name} id={id} placeholder={placeholder} className={className} required={required} onChange={onChange} />
